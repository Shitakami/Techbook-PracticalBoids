...
namespace Part5
{
    // MEMO: Part3のCalculateBoidsSteerForceByNeighborSearchJobをほぼコピペ
    ...
    public struct CalculateBoidsSteerForceJob : IJobParallelFor
    {
        ...
        [ReadOnly] private NativeArray<bool> _aliveFlagDataArrayRead;
        ...
        public void Execute(int ownIndex)
        {
            ...
            var cellIndex = MathematicsUtility.CalculateCellIndex(ownPosition, _gridScale);
